...
# print(df.head())
# """ 
#     output = execute_python_code(sample_code)
#     print("Output from executed code:")
#     print(output)
    # user_query = "print first 5 rows of the excel file"
    # user_query = "find me phone number of John Smith"
    user_query = "find me list of all the customer who have user status as  followed_up"
